...
class Model(object):
    ...
    def __init__(self, args, vocab):
        ...
        # 下方python2和python3不一样(原来用的是/) python2两个整数相除会得到整数 python3会得到浮点数
...
if __name__ == '__main__':
    ...
    if args.dev:
        dev0 = load_sent(args.dev + '.0', args.max_dev_size)
        dev1 = load_sent(args.dev + '.1', args.max_dev_size)

    if args.test:
        test0 = load_sent(args.test + '.0', args.max_test_size)
